...
data = dict(
    ...
    test=dict(
        type=val_dataset_type,
        # lq_folder='/mnt/hpc/zhenglongjie/data/Set5/LRbicx4',
        # gt_folder='/mnt/hpc/zhenglongjie/data/Set5/GTmod12',
        
        lq_folder='/mnt/hpc/zhenglongjie/data/Set14/LRbicx4',
        gt_folder='/mnt/hpc/zhenglongjie/data/Set14/GTmod12',
        pipeline=test_pipeline,
        scale=scale,
        filename_tmpl='{}'))
